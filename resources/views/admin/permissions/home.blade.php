                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('permissions.create')) }}" class="btn sbold green">
                                            <i class="fa fa-plus"></i> اضافة مجموعة صلاحيات جديدة
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('permissions.deletes')) }}')">
                                            تطبيق
                                            </button>
                                        </div>
                                    </div>
