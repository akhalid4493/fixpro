            ...
            <div class="col-md-12">
                <div class="portlet light ">
                    ...
                    <div class="portlet-body form">
                        <form id="form" action="{{url(route('roles.store'))}}" enctype="multipart/form-data" class="form-horizontal form-row-seperated" method="POST">
                            @csrf
                            <div class="portlet">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_general">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="name" placeholder="الصلاحية : Data Entry" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-2">
