...
@section('title','جميع قيمة التركيب')
@section('content')
					...
					<div class="portlet-body">
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										<a href="{{ url(route('installations.create')) }}" class="btn sbold green">
                        ...
                        <div class="row">
                        @permission('delete_installations')
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('installations.deletes')) }}')">
                                تطبيق
                                </button>
                            </div>
                        @endpermission
...
<script> 
 function tableGenerate(data='') {
    ...
    $('#dataTable').DataTable({
        "ajax" : {
            url:"{{ route('installations.dataTable') }}",
            type:"GET",
            data : { 
                req : data, 
            },
