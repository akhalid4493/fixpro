                    ...
                    <div class="portlet-body">
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										<a href="{{url(route('packages.create'))}}" class="btn sbold green">
                        ...
                        <div class="row">
                            @permission('delete_packages')
                                ...
                                <div class="form-group">
                                    <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('packages.deletes')) }}')">
                                    تطبيق
                                    </button>
                                </div>
                            @endpermission
