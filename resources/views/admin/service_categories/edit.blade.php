    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url(route('service_categories.index')) }}">جميع الاقسام</a>
            ...
            <div class="col-md-12">
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">
                        <form id="updateForm" method="POST" action="{{url(route('service_categories.update',$category->id))}}" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio mt-radio-outline"> مفعل
                                                            <input type="radio" name="status" value="1" @if ($category['status'] == 1)
                                                            checked=""
                                                            @endif>
                                                                <span></span>
                                                        </label>
                                                        <label class="mt-radio mt-radio-outline">
                                                            غير مفعل
                                                            <input type="radio" name="status" value="0" @if ($category['status'] == 0)
                                                            checked=""
                                                            @endif>
                                                                <span></span>
                                                        </label>
