					...
					<div class="portlet-body">
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										<a href="{{ url(route('service_categories.create')) }}" class="btn sbold green">
						...
						<div class="row">
							@permission('delete_service_categories')
							<div class="col-md-2">
								<div class="form-group">
							...
							<div class="form-group">
								<button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('service_categories.deletes')) }}')">
									تطبيق
								</button>
							</div>
							@endpermission
...
<script>
 function tableGenerate(data='') {
    ...
    $('#dataTable').DataTable({
        "ajax" : {
            url:"{{ route('service_categories.dataTable','is_service=true') }}",
            type:"GET",
            data : {
                req : data,
            },
