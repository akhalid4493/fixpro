...
namespace App\TheApp\Repository\Api\V2\Orders;

use App\TheApp\Repository\Api\V2\Transaction\TransactionRepository;
    ...
    */
    ...
    public function sendNotifiToUser($order)
    {
        ...
        if (!empty($userToken)) {
            ...
            $data = [
                'title' => 'فاتورة جديدة',
                'body'  => 'تم ارسال فاتوره لطلب المعاينة الخاص بك',
                'type'  => 'orders',
                'id'    => $order->id,
            ];
